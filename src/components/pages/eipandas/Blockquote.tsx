      ...
      <div className="px-6 py-8 rounded-t-lg sm:px-10 sm:pt-10 sm:pb-8">
        ...
        <div className="relative mt-8 text-lg font-medium text-gray-700">
          ...
          <p className="relative">
            The @EIPandas are hoping to be the first PFP project on PoS Ethereum. Follow us for
            future whitelist announcements and special previews before the NFT drop on merge day!
          </p>
        </div>
      </div>
