...
const transferFeatures = [
  {
    ...
    description: (
      <>
        EIPandas will use{" "}
        <Link href="https://www.autominter.com/">AutoMinter</Link> for the mint
        as they launched many successful NFT projects, including EVMavericks.
      </>
    ),
    caption: (
  ...
  },
  {
    ...
    caption: (
      <div className="pt-2 text-sm">
        ...
        <br />• Beacon Chain first <Strong>1,024</Strong> Depositors and
        Proposers
  ...
  },
  {
    ...
    caption: (
      <div className="pt-2 text-sm">
        ...
        <br />
        &nbsp;&nbsp;• <Strong>30%</Strong> to{" "}
        <Link href="https://www.pandasinternational.org/">
...
export const Mint: FunctionComponent = ({ ...otherProps }) => {
  return (
    <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:items-center lg:gap-8">
      <div className="relative">
        ...
        <p className="mt-3 text-lg text-gray-500">
          The project is made and set up by community members of the ManeNet DAO
          (a community formed from EVMavericks holders). We're hoping for it to
          be one of the first successful NFT projects launched after The Merge.
        </p>
